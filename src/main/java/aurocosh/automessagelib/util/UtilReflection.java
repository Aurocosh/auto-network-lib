package aurocosh.automessagelib.util;
...
public class UtilReflection {
    ...
    public static MethodHandle unreflectGetter(Field field) {
        try {
            ...
            AutoMessageLib.logger.error("Unable to unreflect getter for field {} in class {}", field.getName(), field.getDeclaringClass());
            e.printStackTrace();
            return null;
        }
    }
    ...
    public static MethodHandle unreflectSetter(Field field) {
        try {
            ...
            AutoMessageLib.logger.error("Unable to unreflect setter for field {} in class {}", field.getName(), field.getDeclaringClass());
            e.printStackTrace();
            return null;
        }
    }
